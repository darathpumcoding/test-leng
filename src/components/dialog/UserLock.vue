        ...
        <v-dialog transition="dialog-bottom-transition" width="auto">
            <template v-slot:activator="{ props }">
                ...
                <div class="lock-user" v-bind="props">
                    ...
                    <span id="lock-user" class="text-black" style="font-size: 13px;">Lock user</span>
            ...
            <template v-slot:default="{ isActive }">
                <div class="delete-form p-5">
                    ...
                    <h1 class="dialog-title pb-6 text-center">Do you want to lock this user?</h1>
                    <div class="d-flex flex-row justify-between ml-20 mr-20">
                        <BaseButton type="secondary-btn" class="btn-login text-white" @click="isActive.value = false">
                            No</BaseButton>
                        <BaseButton type="primary-btn"  @click="lockUser" class="btn-login text-white" :loading="loading">
                            Yes</BaseButton>
                    </div>
                </div>
